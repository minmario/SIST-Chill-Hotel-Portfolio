...
CREATE TABLE `payment_method` (
  ...
  KEY `FK7wsdmayx3hqba1sx3dytwcar6` (`user_idx`),
  CONSTRAINT `FK7wsdmayx3hqba1sx3dytwcar6` FOREIGN KEY (`user_idx`) REFERENCES `users` (`user_idx`)
...
INSERT INTO `payment_method` VALUES ('2020-02-01','1111','2011-11-11 00:00:00.000000',1,'2025-04-14 03:32:10.158571',18,'신한카드','민재홍','TEMP_TOKEN',NULL);
