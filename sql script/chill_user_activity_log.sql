...
CREATE TABLE `user_activity_log` (
  ...
  `activity_type` enum('ACCOUNT_DELETE','DINING_RESERVATION','HOTEL_RESERVATION','LOGIN','LOGOUT','PASSWORD_CHANGE','PAYMENT','PAYMENT_CANCEL') COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`log_idx`),
  KEY `FKg92s817tc2hc4ewak9tcfn35e` (`user_idx`),
  CONSTRAINT `FKg92s817tc2hc4ewak9tcfn35e` FOREIGN KEY (`user_idx`) REFERENCES `users` (`user_idx`)
