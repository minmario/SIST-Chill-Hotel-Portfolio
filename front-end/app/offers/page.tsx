...
const offers = [
  ...
  },
  {
    ...
    price: "₩400,000부터",
    content:
      "소중한 가족과 함께하는 특별한 시간을 위한 가족 패키지를 소개합니다. 아이들에게는 즐거움을, 부모님에게는 편안함을 선사합니다.\n\n패키지 구성:\n- 패밀리 디럭스 룸 1박\n- 최대 2인 성인, 2인 어린이 조식 뷔페\n- 키즈 웰컴 키트 제공\n- 키즈클럽 무료 이용(4시간)\n- 패밀리 무비 나이트 셋업\n\n추가 혜택:\n- 인근 테마파크 셔틀 서비스\n- 어린이 메뉴 30% 할인\n- 추가 침구류 무료 제공",
  },
  {
    id: 5,
    title: "비즈니스 트래블 패키지",
    ...
    price: "₩300,000부터",
    content:
      "비즈니스 출장의 효율성과 편안함을 모두 고려한 특별 패키지입니다. 업무에 집중할 수 있는 최적의 환경을 제공합니다.\n\n패키지 구성:\n- 비즈니스 디럭스 룸 1박\n- 조식 뷔페\n- 비즈니스 센터 2시간 무료 이용\n- 프리미엄 WiFi 접속\n- 셔츠 1벌 다림 서비스\n- 미니바 무료 이용\n\n추가 혜택:\n- 공항 픽업 서비스 20% 할인\n- 회의실 대여 10% 할인\n- 익스프레스 체크인/체크아웃",
  },
  {
    id: 6,
    title: "시즌 스페셜 - 여름 패키지",
    ...
    price: "₩380,000부터",
    content:
      "무더운 여름, 시원하고 상쾌한 휴가를 위한 특별 패키지입니다. 더위를 잊게 해줄 다양한 혜택을 즐겨보세요.\n\n패키지 구성:\n- 디럭스 룸 1박\n- 2인 조식 뷔페\n- 시원한 웰컴 드링크 제공\n- 야외 수영장 무료 이용 및 선베드 우선 예약\n- 아이스크림 바 이용권(2인)\n\n추가 혜택:\n- 썸머 칵테일 2잔 무료 제공\n- 선크림 키트 제공\n- 수영장 카바나 이용 20% 할인",
  },
]
              ...
              <div className={styles.offerInfo}>
                <div className={styles.offerDescription}>
                  ...
                  <div className={styles.buttonContainer}>
                    <button className="button button-primary">예약하기</button>
